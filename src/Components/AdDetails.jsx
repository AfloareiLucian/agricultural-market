            ...
            <div>
                ...
                <div id="structure">
                    ...
                    <div style={{ borderRadius: "1%", marginLeft: "3%", marginTop: "3%" }}>
                        <h6 className="text-dark">Acasa / {this.props.users_ads[this.props.SET_KEY].Category}/{this.props.users_ads[this.props.SET_KEY].SubCategory}</h6>
                    </div>
                    <br />
                        ...
                        <div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
                            <div id="pricedaba">
                                <div className="setMargin">
                                    ...
                                    <h1 style={{ marginTop: "3%" }} className="text-dark">{this.props.users_ads[this.props.SET_KEY].price} Lei</h1>
                            ...
                            <div id="sellerdaba">
                                <div className="setMargin">
                                    <h4 style={{ marginTop: "3%" }} className="text-dark">Descrierea vanzatorului</h4>
                                    <div style={{ display: "flex" }}>
                                ...
                                <div style={{ display: "flex" }}>
                                    <h4 style={{ marginTop: "1.5%" }} className="text-dark">Anunt postat din :-</h4>
                    ...
                    <div id="disc">
                        <div style={{ marginLeft: "4%" }}>
                            <h4 style={{ marginTop: "3%" }} className="text-dark">Detalii :</h4>
                            <div style={{ display: "flex" }}>
                                <p style={{ marginLeft: "2%", fontWeight: "bolder" }} className="text-secondary">Oferit de : </p>
                                <p className="text-dark" style={{ fontSize: "15px", marginLeft: "25%" }}>{this.props.users_ads[this.props.SET_KEY].itemCondition}</p>
                            </div>
                        </div>
                        <hr />
                        <div style={{ marginLeft: "4%" }}>
                            <h4 style={{ marginTop: "3%" }} className="text-dark">Informatii generale :</h4>
