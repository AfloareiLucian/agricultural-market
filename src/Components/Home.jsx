...
import Ads from './Ads'
import frontPic from '../UI/home_logo.png'
    ...
    render() {
        ...
        return (
            <div className="home-page">
                ...
                <div style={{ position: "relative", backgroundColor: "#F0F2F5", bottom: "-15px" }} id="structure">
                    <Categories />
                    <hr />
                    <img className=".container-fluid" id="frontPic" src={frontPic} alt="This is the front pic" />

                     {(this.props.currentCondition==true)?(
                        <ul style={{ position: "relative", marginTop: "3%"}}>
{/* This is another thing will be called later */}
                        
                        {this.props.users_ads.map((v, i) => {
                            return <li id="mosti" key={i}>
                                <div style={{ display: "inline-block", marginBottom: "50px", padding: "5px" }}>
                                    {/* {console.log("key==>",i)} */}
